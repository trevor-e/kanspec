...
| Standing rules: what prime injects — accepted decisions, active quirks, ranked and budgeted spec rules | rules | src/rulesdoc.rs, src/cmd/prime.rs, src/cmd/rules.rs, src/cmd/spec.rs, src/cmd/quirk.rs, src/cmd/features.rs, src/hooks.rs, src/instructions.rs | p-67f0 |
